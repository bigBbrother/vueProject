...
const {checkInfo, curAddress, showDialog, activeAddress, switchAddress, confirmFn, createOrder} = UseCheckOut()
</script>
...
<template>
  ...
  <el-dialog v-model="showDialog" title="切换收货地址" width="30%" center>
    <div class="addressWrapper">
      <div :class="{active:item.id==activeAddress.id}" class="text item" v-for="item in checkInfo.userAddresses"
